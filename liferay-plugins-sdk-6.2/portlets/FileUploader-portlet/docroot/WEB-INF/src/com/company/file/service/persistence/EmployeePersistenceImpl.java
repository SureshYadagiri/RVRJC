...
import com.company.file.NoSuchEmployeeException;
import com.company.file.model.Employee;
import com.company.file.model.impl.EmployeeImpl;
import com.company.file.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	@Override
	public Employee updateImpl(com.company.file.model.Employee employee)
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setPhno(employee.getPhno());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.company.file.model.Employee")));
