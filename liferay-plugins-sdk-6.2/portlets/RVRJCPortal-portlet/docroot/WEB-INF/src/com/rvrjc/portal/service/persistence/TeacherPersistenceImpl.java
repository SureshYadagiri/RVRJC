...
import com.rvrjc.portal.NoSuchTeacherException;
import com.rvrjc.portal.model.Teacher;
import com.rvrjc.portal.model.impl.TeacherImpl;
import com.rvrjc.portal.model.impl.TeacherModelImpl;
...
public class TeacherPersistenceImpl extends BasePersistenceImpl<Teacher>
	 ...
	 */
	@Override
	public Teacher create(long tid) {
		Teacher teacher = new TeacherImpl();

		teacher.setNew(true);
		teacher.setPrimaryKey(tid);
	 ...
	 */
	@Override
	public Teacher remove(long tid)
		throws NoSuchTeacherException, SystemException {
		return remove((Serializable)tid);
	}
	...
	@Override
	public Teacher updateImpl(com.rvrjc.portal.model.Teacher teacher)
	...
	protected Teacher toUnwrappedModel(Teacher teacher) {
		...
		teacherImpl.setTid(teacher.getTid());
		teacherImpl.setFirstName(teacher.getFirstName());
		teacherImpl.setMiddleName(teacher.getMiddleName());
		teacherImpl.setLastName(teacher.getLastName());
		teacherImpl.setGender(teacher.getGender());
		teacherImpl.setEmail(teacher.getEmail());
		teacherImpl.setPhno(teacher.getPhno());
		teacherImpl.setLiferayUserId(teacher.getLiferayUserId());
	 ...
	 */
	@Override
	public Teacher findByPrimaryKey(long tid)
		throws NoSuchTeacherException, SystemException {
		return findByPrimaryKey((Serializable)tid);
	}
	 ...
	 */
	@Override
	public Teacher fetchByPrimaryKey(long tid) throws SystemException {
		return fetchByPrimaryKey((Serializable)tid);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rvrjc.portal.model.Teacher")));
