 ...
 * @generated
 */
public abstract class ParentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ParentActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ParentLocalServiceUtil.getService());
		setClass(Parent.class);

		setClassLoader(com.rvrjc.portal.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("parentId");
	}
}